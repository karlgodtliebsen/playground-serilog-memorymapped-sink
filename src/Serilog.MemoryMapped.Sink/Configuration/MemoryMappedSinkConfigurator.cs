...
public static class MemoryMappedSinkConfigurator
{
    ...
    public static LoggerConfiguration SetupApplicationLoggingMsSqlSink(this LoggerSinkConfiguration sinkConfiguration, IServiceProvider serviceProvider, LogEventLevel restrictedToMinimumLevel = LogEventLevel.Information)
    {
