...
public class LogEventWithMessageTemplateMemoryMappedSink(IMemoryMappedQueue<LogEventWithMessageTemplateWrapper> memoryMappedQueue,
    LogEventLevel restrictedToMinimumLevel = LogEventLevel.Information) : ILogEventSink, IBatchedLogEventSink
{
    ...
    public void Emit(LogEvent logEvent)
    {
        try
        {
            ...
            LogEventWithMessageTemplateWrapper logEventWrapper = new LogEventWithMessageTemplateWrapper(
                logEvent.Timestamp, logEvent.Level, logEvent.MessageTemplate.Text, renderedMessage,
